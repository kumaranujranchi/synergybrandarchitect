...
export default function BlogDetail() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-white">
        <Header />
        <div className="container mx-auto px-4 pt-44 md:pt-56 pb-20">
  ...
  if (!blog) {
    return (
      <div className="min-h-screen bg-white">
        <Header />
        <div className="container mx-auto px-4 pt-44 md:pt-56 pb-20 text-center">
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <article className="pt-44 md:pt-56 pb-20">
