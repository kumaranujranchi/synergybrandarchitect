  ...
  return (
    <section id="about" className="section-padding">
      <div className="container mx-auto container-padding">
        ...
        <motion.div
          className="mt-20 relative overflow-hidden group"
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        >
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-orange-600 rounded-[2.5rem]" />
          
          <div className="relative p-8 md:p-12 flex flex-col items-center text-center max-w-3xl mx-auto">
            <div className="text-white">
              ...
              <blockquote className="text-xl md:text-2xl font-poppins italic font-medium mb-8 leading-relaxed">
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <p className="text-orange-100/80 font-inter text-base">
